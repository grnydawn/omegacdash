...
#SBATCH  --output=/global/cfs/cdirs/e3sm/omega/cdash/logs/OmegaCDashCPU_%j.out
#SBATCH  --error=/global/cfs/cdirs/e3sm/omega/cdash/logs/OmegaCDashCPU_%j.err
...
MACHINE=pm-cpu
ARCH=SERIAL
PARMETIS_ROOT=/global/cfs/cdirs/e3sm/software/polaris/pm-cpu/spack/dev_polaris_0_6_0_${COMPILER}_mpich/var/spack/environments/dev_polaris_0_6_0_${COMPILER}_mpich/.spack-env/view
